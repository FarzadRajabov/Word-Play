...
export default function FillBlank() {
  ...
  const startGame = (wordsWithExamples: Word[]) => {
    const selectedWords = wordsWithExamples.sort(() => 0.5 - Math.random()).slice(0, GAME_SIZE)
  ...
  const generateQuestion = (gameWords: Word[], index: number) => {
    ...
    const blankSentence = exampleSentence.replace(new RegExp(`\\b${currentWord.term}\\b`, "i"), "________")
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="max-w-md mx-auto">
          <CardHeader>
            ...
            <CardDescription>
              You need at least {GAME_SIZE} words with example sentences to play Fill in the Blank.
            </CardDescription>
          </CardHeader>
          <CardFooter>
      ...
      {!gameOver ? (
        <Card className="max-w-2xl mx-auto">
          <CardHeader>
            ...
            <CardDescription className="text-center">Choose the word that best completes the sentence</CardDescription>
